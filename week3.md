...
주제는 반드시 내가 적은 범위에서만 골라줘.  
너는 질문을 하나씩 내주고, 나는 맞추는 식으로 진행할게.  
질문은 20개까지 가능해. 시작해보자!
```
...
[![image.png](https://i.postimg.cc/bJShMDCw/image.png)](https://postimg.cc/ftspSLQG)
...
### 2️⃣ Git을 모르는 친구에게 드라마로 설명하기 🎬👥

짧은 만화 형식은 분량이 부족했죠.<br />
이번엔 **드라마 대본 형식** 으로 AI와 대사를 주고받으며 Git 개념을 설명해 보세요.
...
> [!NOTE]
>
> - AI는 상황을 만들어 질문을 던집니다.<br />
> - 나는 '준형'이라는 캐릭터로 대사를 선택하며 Git 개념을 설명합니다.<br />
> - AI가 스토리를 이어가면서 Git을 모르는 친구에게 이해시킬 수 있도록 도움을 줍니다.
...
소설의 재미와 학습 효과를 높이기 위해 아래 정보를 참고해주세요:
...
### 🔹 미션 2 – Git을 모르는 친구에게 드라마로 설명하기 (담당: J017_곽윤철)
